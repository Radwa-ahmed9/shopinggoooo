...
void main() async {
  ...
  runApp(
    DevicePreview(
      ...
      builder: (context) => StoreApp(), // Wrap StoreApp with DevicePreview
    ),
  );
}
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        builder: DevicePreview.appBuilder, // Add DevicePreview.builder here
        useInheritedMediaQuery: true, // To adapt media queries from the device preview
        locale: DevicePreview.locale(context), // To simulate locales in preview
